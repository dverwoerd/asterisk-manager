...
class ExtensionsController extends BaseController
{
    ...
    private function collectFormData(): array
    {
        return [
            ...
            'voicemail_greeting' => trim($this->post('voicemail_greeting', '')),
            ...
            'notes'            => trim($this->post('notes', '')),
            'allowed_ips'       => implode(',', array_filter(array_map('trim', $this->post('allowed_ips_list', [])))),  
    ...
    private function defaults(): array
    {
        return [
            ...
            'voicemail_enabled' => 0, 'voicemail_pin' => '', 'voicemail_greeting' => '',
